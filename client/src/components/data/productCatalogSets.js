const productCatalogSets = [ {id: 2,
    ...
    description: "Комплексные решения для скейтпарков.",
     description3: "Не чекай ідеального парку — створи його сам. Фігура за фігурою. Трюк за трюком.",
          description2: "Комплексные решения для скейтпарков.Всі фігури зроблені в Україні, для українських умов. Дощ, сонце, мороз — їм по барабану. Мiцна фанера, покриття, яке не відпускає. Доставка туди, де ти збираєш свою банду.Не чекай ідеального парку — створи його сам. Фігура за фігурою. Трюк за трюком.",
    details: [
