      ...
      <div className="flex flex-col min-h-screen">
        <div className="z-50 flex-shrink-0">
          <SocialButtons
            ...
            onButtonClick={() => navigate("/catalogue")}
            buttonAnimationProps={{ whileTap: { scale: 0.85, opacity: 0.6 } }}
          /><div className="hidden fixed lg:block right-0 top-5 z-20000 text-right mb-10">
  <p className="font-futura text-[#717171] font-light text-[35px] tracking-[-1px]">твій парк — твоя історія. ми просто допомагаємо зробити її реальною.
